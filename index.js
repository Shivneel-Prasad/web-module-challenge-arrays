...
// adding an array as a parameter - boolean 
function is31Flavors(array){
    // if the array.length is 31 return true else return false
    if(array.length === 31){
        return true;
    } else {
        return false;
...
function removeFlavorByName(array, string){
  // loop through the array and check the index for the string
  // conditional that checks for an exact match ===
  // if the item matches the string remove the item at the specific index .splice - index(i) and the number of items to delete
